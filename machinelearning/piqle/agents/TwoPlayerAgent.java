...
*/
	...
	if(oldState!=null){
	    double r=universe.getReward(oldState,s, lastAction); 
	    reward=r; 
    ...
    /** Same as above, technical difference when the play comes to an end : 
     * we need to change the <i>turn indicator</i> back, as the non-playing
     * player must be rewarder at the end of the game. */
