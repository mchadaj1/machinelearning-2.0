 ...
 * At some moments, the <code>Sample</code>s gathered into a
 * <code>Dataset</code> are fed into a neural network, which is asked to learn
 * Q(s,a) from this dataset.<br>
...
public class RewardMemorizerNN implements IRewardStore {
	...
	public double get(IState s, IAction a) {
		...
		if (memory != null) {
			...
			return this.valueChooser.getValue();
	}
