...
/** A container of elementary µAgent actions, using an ArrayList
...
public class ComposedActionArrayList extends AbstractComposedAction 
	...
	public void addElementaryAction(ElementaryAgent agent, IAction action) {
		...
		this.listOfAgents.add(agent.getRank(),agent);
	}
	/**
	...
	public IAction copy() {
		...
		for(int i=0;i<thisList.size();i++){
				...
				if(ActionToCopy!=null){
					...
					nouveau.listOfAgents.add(i,this.listOfAgents.get(i));
				}
		}
		return nouveau; 
